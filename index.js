...
function calculateTotalChanges(finances) {
    let totalChanges = 0;
...
function calculateAverageChanges(finances) {
    return calculateTotalChanges(finances) / (calculateTotalMonths(finances) - 1);
}
...
function greatestIncrease(finances) {
    ...
    let month = ""
    for (let i = 1; i < finances.length; i++) {
        let previousElement = finances[i - 1][1];
        let currentElement = finances[i][1];
        let currentIncrease = currentElement - previousElement;
...
function greatestDecrease(finances) {
    ...
    for (let i = 1; i < finances.length; i++) {
        let previousElement = finances[i - 1][1];
        let currentElement = finances[i][1];
        let currentDecrease = previousElement - currentElement;
